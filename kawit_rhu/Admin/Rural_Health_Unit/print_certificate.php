...
$stmt = $pdo->prepare("
    SELECT mc.*, 
           ...
           p.date_of_birth, p.gender, p.address, p.phone,
...
// IMPORTANT: Replace 'localhost/kawit_rhu' with your actual domain when deploying
$verification_url = 'http://localhost/kawit_rhu/verify_certificate.php?cert=' . $certificate['certificate_number'];
// For production, use:
// $verification_url = 'https://yourdomain.com/verify_certificate.php?cert=' . $certificate['certificate_number'];
